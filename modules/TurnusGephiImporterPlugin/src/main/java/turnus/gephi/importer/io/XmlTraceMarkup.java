...
public class XmlTraceMarkup {
    ...
    public static final String DEPENDENCY_KIND_FSM = "fsm";
    public static final String DEPENDENCY_KIND_GUARD = "guard";
    public static final String DEPENDENCY_KIND_PORT = "port";
    public static final String DEPENDENCY_KIND_STATEVAR = "state-variable";
    public static final String DEPENDENCY_KIND_TOKENS = "tokens";
    public static final String DEPENDENCY_KIND_UNKNOWN = "unknown";
